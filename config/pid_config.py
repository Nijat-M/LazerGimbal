...
class PIDConfig:
    ...
    # ==========================
    KP = 0.4    # 比例系数 (Proportional Gain) - 温和的响应速度
    KI = 0.0    # 积分系数 (Integral Gain) - 云台系统通常不需要积分
    KD = 0.2    # 微分系数 (Derivative Gain) - 良好的阻尼，减少震荡
    
    # ==========================
    # 运动限制 (温和版 - 智能速度控制)
    # ==========================
    MAX_STEP = 20           # 基础最大步数（代码中动态调整）
    MAX_STEP_FAST = 25      # 远距离时的最大速度（降低避免过冲）
    MAX_STEP_MEDIUM = 15    # 中距离时的速度
    MAX_STEP_SLOW = 8       # 接近目标时的速度
    DEADZONE = 15           # 基础死区（像素）- 代码中使用自适应死区
